...
bool operator==(const ::chapter3_tutorials::SetSpeedResponse_<ContainerAllocator1> & lhs, const ::chapter3_tutorials::SetSpeedResponse_<ContainerAllocator2> & rhs)
{
  return lhs.previous_speed == rhs.previous_speed &&
    lhs.new_speed == rhs.new_speed &&
